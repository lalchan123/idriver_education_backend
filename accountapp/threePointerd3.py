...
def PointerValueRangeFunc(starting_point, starting_value, rule_data, value0, value1, value2, daygap):
    XDataList1, XDataListOutput1=XAxisFunc(day=1, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    XDataList2, XDataListOutput2=XAxisFunc(day=2, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data,  daygap=daygap)
    XDataList3, XDataListOutput3=XAxisFunc(day=3, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data,  daygap=daygap)
  

    YDataList1, YDataListOutput1=YAxisFunc(day=1, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    YDataList2, YDataListOutput2=YAxisFunc(day=2, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data,  daygap=daygap)
    YDataList3, YDataListOutput3=YAxisFunc(day=2, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data,  daygap=daygap)
    
    return CombinationValue(value0, value1, value2, XDataList1, YDataList1, XDataList2, YDataList2, XDataList3, YDataList3)


def PointerCalculationd3(starting_point, starting_value, rule_data, value_range_list2, dfList, count, SumList, daygap, first_run, input_p, d1_point0,  d1_point1, d2_point2, minp_value):
    XDataList1, XDataListOutput1=XAxisFunc(day=1, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    XDataList2, XDataListOutput2=XAxisFunc(day=2, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    XDataList3, XDataListOutput3=XAxisFunc(day=3, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    ...
    YDataList1, YDataListOutput1=YAxisFunc(day=1, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    YDataList2, YDataListOutput2=YAxisFunc(day=2, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    YDataList3, YDataListOutput3=YAxisFunc(day=3, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)

    
    day1 = XDataListOutput1[::-1]+YDataListOutput1
    day2 = XDataListOutput2[::-1]+YDataListOutput2
    day3 = XDataListOutput3[::-1]+YDataListOutput3
    ...
    if first_run == "YES" or first_run == "Yes" or first_run == "yes":
        uniqueCombination= UniqueCombination(day1[15:26], day2[15:26], day3[15:26])
        ...
        if input_p == "YES" or input_p == "Yes" or input_p == "yes":
            ...
            d1_point1 = d1_point1
            d2_point2 = d2_point2
            uniqueCombination= [(d1_point0, d1_point1, d2_point2)]
    ...
    for i in uniqueCombination:
        ...
        DataList1 = CombinationValue(i[0], i[1], i[2], XDataList1, YDataList1, XDataList2, YDataList2, XDataList3, YDataList3)
        DataList2 = PointerValueRangeFunc(value_range_list2[0], starting_value, rule_data, i[0],  i[1],  i[2], daygap)
        DataList3 = PointerValueRangeFunc(value_range_list2[1], starting_value, rule_data, i[0],  i[1],  i[2], daygap)
        DataList = DataList1+DataList2+DataList3
        SList=[]
        Section={}
        if len(DataList)!=0 and len(DataList)==3:
            sum_value1 = DataList[0]['data1']+DataList[0]['data12']+DataList[0]['data2']
    ...
    if first_run == "YES" or first_run == "Yes" or first_run == "yes":
        ...
        if input_p == "YES" or input_p == "Yes" or input_p == "yes":
            ...
            df.insert(5, "created_time", strftime("%Y-%m-%d %H:%M:%S", gmtime()), True)
            sum_max_df1.insert(17, "remarks", "sum_max_value", True)
            sum_max_df1.insert(18, "first_run", first_run, True)
            ExcelFileWrite(file_name1, df)
            summary_df = pd.read_excel(file_name1)
            return summary_df

        elif input_p == "NO" or input_p == "No" or input_p == "no":    
            d1_point0, d1_point1, d2_point2 = sum_max_df1['d1_point0'].iloc[0], sum_max_df1['d1_point1'].iloc[0], sum_max_df1['d2_point2'].iloc[0]
            sum_max_df2 = df[(df['d1_point0'] == d1_point0) & (df['d1_point1'] == d1_point1) & (df['d2_point2'] == d2_point2)]
