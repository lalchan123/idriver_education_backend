...
def CombinationValue(value0, value1, value2, XDataList1, YDataList1, XDataList2, YDataList2):
    dfList=[]
    new_row={}
    ...
    x_data_day12 = [x for x in XDataList1 if x['starting_point'] == value1]
    y_data_day12 = [x for x in YDataList1 if x['starting_point'] == value1]
    ...
    x_data_day2 = [x for x in XDataList2 if x['starting_point'] == value2]
    y_data_day2 = [x for x in YDataList2 if x['starting_point'] == value2]
...
def PointerValueRangeFunc(starting_point, starting_value, rule_data, value0, value1, value2, daygap):
    ...
    return CombinationValue(value0, value1, value2, XDataList1, YDataList1, XDataList2, YDataList2)


def PointerCalculation3(starting_point, starting_value, rule_data, value_range_list2, dfList, count, SumList, daygap, first_run, input_p, d1_point0,  d1_point1, d2_point2, minp_value):
    XDataList1, XDataListOutput1=XAxisFunc(day=1, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    XDataList2, XDataListOutput2=XAxisFunc(day=2, starting_point=starting_point, starting_value=starting_value, rule_data=rule_data, daygap=daygap)
    ...
    if first_run == "YES" or first_run == "Yes" or first_run == "yes":
        uniqueCombination= UniqueCombination(day1[15:26], day1[15:26], day2[15:26])
    ...
    for i in uniqueCombination:
        ...
        DataList1 = CombinationValue(i[0], i[1], i[2], XDataList1, YDataList1, XDataList2, YDataList2)
